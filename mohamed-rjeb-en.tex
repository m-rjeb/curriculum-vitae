...
\usepackage{xcolor}
\definecolor{accentTitle}{HTML}{8055a2}
\definecolor{accentText}{HTML}{8055a2}
\definecolor{accentLine}{HTML}{8055a2}
...
% Usage: \sectionTitle{Title}
\newcommand{\sectionTitle}[1]{
  \phantomsection
  \addcontentsline{toc}{section}{#1}
  {\large{\bfseries\vspace{10pt}\color{accentText}#1\vspace{12pt}} {\color{accentLine}\hspace{0.15cm}\titlerule[0.8pt]}}
}
...
\begin{document}
  ...
  \documentTitle{Mohamed Rjeb}{
    \href{tel:+21658299492}{
      \raisebox{-0.15\height} \faPhone\ +216-58299492} ~ || ~
    \href{mailto:rjebmohamed10@gmail.com}{
      \raisebox{-0.15\height} \faEnvelope\ rjebmohamed10@gmail.com} ~ || ~
    \href{https://linkedin.com/in/mohamedrjeb/}{
      \raisebox{-0.15\height} \faLinkedin\ linkedin.com/in/mohamedrjeb} ~ || ~
    \href{https://maps.app.goo.gl/TYtLp1YgykbQA3fo7}{
      \raisebox{-0.15\height} \faMapMarker\ Tunis, Tunisia}
}
  ...
  %\section{Summary}
  I am an IT engineer with five years of experience, specializing in DevOps engineering. Currently seeking an
  opportunity in a dynamic team, I am eager to leverage my expertise in deployment automation, continuous
  delivery process optimization, and cloud environment management. My goal is to contribute to enhancing the
  efficiency and reliability of infrastructures and workflows within the organization.  
  %--------%
  % Skills %
  %--------%
  ...
  \sectionTitle{Skills}
    ...
    \begin{itemize}[itemsep=5px, parsep=1pt, leftmargin=75pt]
